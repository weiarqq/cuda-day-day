...
int main(int argc, char** argv)
{
    ...
    CHECK_CUSPARSE(cusparseDense2csr(handle, M, N, descr,
        dA, CUDA_R_32F, M, dNnzPerRow,
        dCsrValA, CUDA_R_32F,
        dCsrRowPtrA, CUDA_R_32I,
        dCsrColIndA, CUDA_R_32I,
        CUSPARSE_DENSE2CSR_ALG_DEFAULT));

    CHECK_CUSPARSE(cusparseCsrmv(handle, CUSPARSE_OPERATION_NON_TRANSPOSE,
        M, N, totalNnz,
        &alpha, CUDA_R_32F,
        descr,
        dCsrValA, CUDA_R_32F,
        ...
        &beta, CUDA_R_32F,
        dY, CUDA_R_32F,
        CUSPARSE_CSRMV_ALG_DEFAULT, NULL));
